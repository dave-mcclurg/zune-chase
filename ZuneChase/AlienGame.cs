...
namespace AlienGameSample
{
    ...
    public class GameplayScreen : GameScreen
    {
        ...
        public GameplayScreen()
        {
            ...
            worldBounds = new Rectangle(0, 0, 240, 320);
        ...
        private void DrawBackground(float elapsedTime)
        {
            ...
            // Draw the mountains
            ScreenManager.SpriteBatch.Draw(mountainsTexture, new Vector2(0, 320 - mountainsTexture.Height), tint);

            // Draw the hills
            ScreenManager.SpriteBatch.Draw(hillsTexture, new Vector2(0, 320 - hillsTexture.Height), tint);

            // Draw the ground
            ScreenManager.SpriteBatch.Draw(groundTexture, new Vector2(0, 320 - groundTexture.Height), tint);
        ...
        void DrawHud()
        {
            ...
            else
            {
                ...
                DrawString(scoreFont, text, new Vector2(234 - (int)size.X, 300), Color.Yellow);
            }
        }
